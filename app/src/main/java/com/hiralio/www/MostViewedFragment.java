...
public class MostViewedFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        report_listview = (GridView) view.findViewById(R.id.most_viewed_gridview);
    ...
    private void getReport(){
        StringRequest stringRequest = new StringRequest("http://hiralio.inetrip.com/hr_photo_viewed.php?roomId=1", new Response.Listener<String>() {
            @Override
