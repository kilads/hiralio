...
public class MostLovedFragment extends Fragment{
   ...
   GridView report_listview;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_most_loved, container, false);


       arraylist = new ArrayList<HashMap<String, String>>();

        report_listview = (GridView) view.findViewById(R.id.most_loved_gridview);
    ...
    private void getReport(){
        StringRequest stringRequest = new StringRequest("http://hiralio.inetrip.com/hr_photo_loved.php?roomId=1", new Response.Listener<String>() {
            @Override
