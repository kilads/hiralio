...
public class MostSavedFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_most_saved, container, false);


        arraylist = new ArrayList<HashMap<String, String>>();

        report_listview = (GridView) view.findViewById(R.id.most_saved_gridview);
    ...
    private void getReport(){
        StringRequest stringRequest = new StringRequest("http://hiralio.inetrip.com/hr_photo_saved.php?roomId=1", new Response.Listener<String>() {
            @Override
